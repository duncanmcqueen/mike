                    ...
                    <div className="flex shrink-0 items-center rounded-full border border-white/70 bg-app-surface p-0.5 shadow-[0_8px_24px_rgba(15,23,42,0.06)] backdrop-blur-2xl">
                        {featureEnabled(
                            ...
                            <button
                                ...
                                className={`flex h-6 items-center justify-center gap-1 rounded-full px-2.5 text-xs font-medium text-gray-500 transition-colors hover:text-gray-900 disabled:opacity-45 ${APP_SURFACE_HOVER_CLASS} ${APP_SURFACE_PRESSED_CLASS}`}
                            >
