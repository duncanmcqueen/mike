export const LIQUID_TABLE_SURFACE_CLASS =
    "rounded-2xl border border-white/70 bg-white/55 shadow-sm";

export const APP_PANEL_SHADOW_CLASS =
    "shadow-[0_-1px_6px_rgba(15,23,42,0.034),0_4px_9px_rgba(15,23,42,0.074),inset_0_1px_0_rgba(255,255,255,0.85)]";
...
export const APP_SURFACE_GROUP_HOVER_CLASS = "group-hover:bg-app-surface-hover";
